              ...
              <div className="grid grid-cols-2 gap-2">
                {quickLinks.map((link) => (
                  ...
                  >
                    ...
                    <span className="font-[family-name:var(--font-oswald)] text-xs uppercase tracking-wider text-charcoal">
                      {link.label}
                    </span>
                  </Link>
                ))}
              ...
              <div className="space-y-3">
                {products.slice(0, 5).map((product) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-[family-name:var(--font-oswald)] uppercase tracking-wider px-2 py-1 ${
                        product.active
