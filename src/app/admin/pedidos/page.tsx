      ...
      <div className="bg-cream card-retro max-w-2xl w-full max-h-[80vh] overflow-y-auto p-6" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="font-[family-name:var(--font-libre)] text-xs text-charcoal/40 mt-1">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-cream-dark/50">
              ...
              <p className="font-[family-name:var(--font-libre)] text-sm text-charcoal mt-1">
                {order.customer_name || "Sin nombre"}
              </p>
              <p className="font-[family-name:var(--font-libre)] text-xs text-charcoal/50 mt-1">
                {order.customer_email}
              </p>
              {order.customer_phone && (
                <p className="font-[family-name:var(--font-libre)] text-xs text-charcoal/50">
                  {order.customer_phone}
                </p>
              )}
            </div>
            <div className="p-4 bg-cream-dark/50">
              ...
              <div className="mt-1">
                {(() => {
                  ...
                  return <span className={`inline-block px-2 py-0.5 text-xs font-[family-name:var(--font-libre)] uppercase ${s.color}`}>{s.label}</span>
                })()}
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {[
                ...
                <button
                  ...
                  className={`font-[family-name:var(--font-libre)] text-[10px] uppercase tracking-wider px-3 py-1.5 transition-all disabled:opacity-30 disabled:cursor-not-allowed ${opt.color}`}
                >
                  {opt.label}
                </button>
              ))}
            ...
            <div className="mt-2 space-y-2">
              {(order.items || []).map((item, i) => (
                <div key={i} className="flex items-center justify-between p-3 bg-cream-dark/50">
                  <div>
                    <p className="font-[family-name:var(--font-libre)] text-sm text-charcoal">{item.name}</p>
                    <p className="font-[family-name:var(--font-libre)] text-xs text-charcoal/40">x{item.quantity}</p>
                  </div>
                  <span className="font-[family-name:var(--font-libre)] text-sm text-charcoal">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-charcoal/10">
            <span className="font-[family-name:var(--font-libre)] text-sm uppercase text-charcoal/50">Total</span>
            <span className="font-[family-name:var(--font-libre)] text-lg font-semibold text-charcoal">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-charcoal/10">
              <th className="text-left py-3 px-4 font-[family-name:var(--font-libre)] text-[10px] uppercase tracking-[0.2em] text-charcoal/40">Ref</th>
              <th className="text-left py-3 px-4 font-[family-name:var(--font-libre)] text-[10px] uppercase tracking-[0.2em] text-charcoal/40">Cliente</th>
              ...
              <th className="text-right py-3 px-4 font-[family-name:var(--font-libre)] text-[10px] uppercase tracking-[0.2em] text-charcoal/40">Total</th>
            ...
            {orders.map((order) => {
              ...
              return (
                <tr key={order.id} className="border-b border-charcoal/5 hover:bg-charcoal/[0.02] transition-colors">
                  <td className="py-3 px-4 font-[family-name:var(--font-libre)] text-xs text-charcoal/40">
                    {order.external_reference}
                  </td>
                  <td className="py-3 px-4">
                    <p className="font-[family-name:var(--font-libre)] text-sm text-charcoal">{order.customer_name || "Sin nombre"}</p>
                    <p className="font-[family-name:var(--font-libre)] text-xs text-charcoal/40">{order.customer_email}</p>
                  </td>
