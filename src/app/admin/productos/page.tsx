    ...
    <div>
      ...
      {loading && (
        <div className="card-retro p-8 text-center">
          <p className="font-[family-name:var(--font-oswald)] text-sm uppercase tracking-wider text-charcoal/40 animate-pulse">
            Cargando productos...
          </p>
        </div>
      )}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-charcoal/10 bg-cream-dark">
                <th className="text-left p-4 font-[family-name:var(--font-oswald)] text-[10px] uppercase tracking-[0.2em] text-charcoal/50">
                  Producto
                </th>
                <th className="text-left p-4 font-[family-name:var(--font-oswald)] text-[10px] uppercase tracking-[0.2em] text-charcoal/50 hidden sm:table-cell">
                  Categoría
                </th>
                <th className="text-left p-4 font-[family-name:var(--font-oswald)] text-[10px] uppercase tracking-[0.2em] text-charcoal/50 hidden md:table-cell">
                  Precio
                </th>
                <th className="text-left p-4 font-[family-name:var(--font-oswald)] text-[10px] uppercase tracking-[0.2em] text-charcoal/50 hidden md:table-cell">
                  Stock
                ...
                <th className="text-right p-4 font-[family-name:var(--font-oswald)] text-[10px] uppercase tracking-[0.2em] text-charcoal/50">
                  Acciones
                </th>
              </tr>
            </thead>
              ...
              {products.map((product) => (
                ...
                >
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-charcoal/30 font-[family-name:var(--font-oswald)] uppercase">
                  ...
                  <td className="p-4 hidden md:table-cell">
                    <span className="font-[family-name:var(--font-oswald)] text-sm font-medium text-charcoal">
                  ...
                  <td className="p-4 hidden md:table-cell">
                    <span
                      className={`font-[family-name:var(--font-oswald)] text-sm ${
                  ...
                  <td className="p-4">
                    <button
                      ...
                      className={`inline-flex items-center gap-1 text-[10px] font-[family-name:var(--font-oswald)] uppercase tracking-wider px-2 py-1 rounded transition-colors ${
                        product.active
