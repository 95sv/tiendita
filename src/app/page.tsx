          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/hombres" className="group relative rounded-2xl overflow-hidden aspect-[16/10] flex items-end">
              ...
              <div className="relative z-10 p-8">
                <span className="font-[family-name:var(--font-bungee)] text-[10px] uppercase tracking-[0.3em] text-rust" style={{ textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>
                  Colección
                </span>
                <h3 className="font-[family-name:var(--font-changa)] text-4xl font-bold uppercase tracking-[0.04em] text-cream mt-1" style={{ textShadow: "0 2px 8px rgba(0,0,0,0.4)" }}>
                  Hombres
                </h3>
              </div>
            </Link>
