          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/hombres" className="group relative rounded-2xl overflow-hidden aspect-[16/10] flex items-end">
              ...
              <div className="relative z-10 p-8">
                <span className="font-[family-name:var(--font-bungee)] text-[10px] uppercase tracking-[0.3em] text-rust" style={{ textShadow: "0 0 6px rgba(0,0,0,0.3), 0 0 12px rgba(0,0,0,0.2)" }}>
                  Colección
                </span>
