    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-2 mb-8 border-b border-charcoal/10 pb-4">
          {categories.map((cat) => (
            <button
              ...
              className={`font-[family-name:var(--font-libre)] text-xs uppercase tracking-[0.15em] px-4 py-2 transition-all ${
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <p className="font-[family-name:var(--font-libre)] text-sm uppercase tracking-wider text-charcoal/30">
